...
navigator.mediaDevices.getUserMedia({
    ...
    // Call setup after setting the stream
    setup();
}).catch((error)=>{
...
async function setup() {
    ...
    const vision = await (0, _tasksVision.FilesetResolver).forVisionTasks("https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@latest/wasm");
    ...
    // Start the render loop after setup is complete
...
function renderLoop() {
    ...
    if (poseLandmarker && video.readyState >= 2 && video.videoWidth > 0 && video.videoHeight > 0 && video.currentTime !== lastVideoTime) {
        debugLog('Calling detectForVideo...');
        const poseLandmarkerResult = poseLandmarker.detectForVideo(video, performance.now());
        debugLog('detectForVideo result: ' + JSON.stringify(poseLandmarkerResult));
...
canvas.width = 640;
canvas.height = 480;
// Define the connections between landmarks for a stick figure
...
function processResults(results) {
    if (results.landmarks && results.landmarks[0]) {
        ...
        if (angle < 90 && stage !== 'down') {
            stage = 'down';
            debugLog('Stage: down, Angle: ' + angle.toFixed(2));
        }
        if (angle > 160 && stage === 'down') {
            stage = 'up';
            repCount++;
            document.getElementById('repCount').innerText = `Reps: ${repCount}`;
            debugLog('Rep counted! Total: ' + repCount + ', Angle: ' + angle.toFixed(2));
        }
    }
}
function debugLog(msg) {
    if (!logDebugMessages) return;
    const debugDiv = document.getElementById('debugWindow');
    if (debugDiv) {
...
document.getElementById('debugToggle').addEventListener('change', (event)=>{
    logDebugMessages = event.target.checked;
    if (logDebugMessages) debugLog("Debug logging enabled.");
    else {
        const debugDiv = document.getElementById('debugWindow');
        if (debugDiv) debugDiv.innerText = 'Debug logging disabled.\n';
    }
});
...
parcelHelpers.export(exports, "DrawingUtils", ()=>Ia) //# sourceMappingURL=vision_bundle_mjs.js.map
;
parcelHelpers.export(exports, "FaceDetector", ()=>Za);
parcelHelpers.export(exports, "FaceLandmarker", ()=>uc);
parcelHelpers.export(exports, "FaceStylizer", ()=>lc);
parcelHelpers.export(exports, "FilesetResolver", ()=>Uo);
parcelHelpers.export(exports, "GestureRecognizer", ()=>mc);
parcelHelpers.export(exports, "HandLandmarker", ()=>_c);
parcelHelpers.export(exports, "HolisticLandmarker", ()=>Ac);
parcelHelpers.export(exports, "ImageClassifier", ()=>bc);
parcelHelpers.export(exports, "ImageEmbedder", ()=>kc);
parcelHelpers.export(exports, "ImageSegmenter", ()=>Rc);
parcelHelpers.export(exports, "ImageSegmenterResult", ()=>Sc);
parcelHelpers.export(exports, "InteractiveSegmenter", ()=>Vc);
parcelHelpers.export(exports, "InteractiveSegmenterResult", ()=>Fc);
parcelHelpers.export(exports, "MPImage", ()=>Ga);
parcelHelpers.export(exports, "MPMask", ()=>Ea);
parcelHelpers.export(exports, "ObjectDetector", ()=>Xc);
parcelHelpers.export(exports, "PoseLandmarker", ()=>Kc);
parcelHelpers.export(exports, "TaskRunner", ()=>Zo);
parcelHelpers.export(exports, "VisionTaskRunner", ()=>Ja);
...
function ga(t) {
    if (t = pa(t), !va) {
        if (t.getExtension("EXT_color_buffer_float") && t.getExtension("OES_texture_float_linear") && t.getExtension("EXT_float_blend")) va = t.R32F;
        else {
...
function Ka(t, e, n, r) {
    if (t.U) {
        ...
        if (n?.rotationDegrees) {
            if (n?.rotationDegrees % 90 != 0) throw Error("Expected rotation to be a multiple of 90\xb0.");
...
var Ac = class extends Ja {
    ...
    m() {
        ...
        tn(n, 1, de("type.googleapis.com/mediapipe.tasks.vision.holistic_landmarker.proto.HolisticLandmarkerGraphOptions"), ""), function(t, e) {
            if (null != e) {
                if (Array.isArray(e)) He(t, 2, Pe(e, Oe, void 0, void 0, !1));
                else {
...
},{}]},["n0fw4","kTBnD"], "kTBnD", "parcelRequirebbc2", {})

//# sourceMappingURL=Mediapipe-web.3c14d121.js.map
